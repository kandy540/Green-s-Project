            ...
            <div class="carousel-inner" role="listbox">
                <div class="item active">
                    ...
                    <div class="carousel-caption">
                        <h2 class="animated bounceInRight" style="animation-delay: 1s"><span>Green's Grill & Sushi Bar</span></h2>
                        <h3 class="animated bounceInLeft" style="animation-delay: 2s">Best Sushi in town!</h3>
                        <p class="animated bounceInRight" style="animation-delay: 3s"><a href="tel:5554280940">Contact us</a></p>
                    </div>
                </div>
                <div class="item">
